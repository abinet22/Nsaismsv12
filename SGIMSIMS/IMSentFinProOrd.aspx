<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IMSentFinProOrd.aspx.cs" Inherits="SGIMSIMS.IMSentFinProOrd" %>
            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                        ...
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Send Finish Order</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
             <div class="col-sm-12">
                <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Alert</span> አጠቃላይ  
                     <asp:Label ID="Labelfinshorder" class="card-title" runat="server" Text=" "></asp:Label>
                    ያለቁ ትዕዛዞት ኣሉ። እባክዎን ተመልክተው ለሽያጭ ባለሙያ ያሳውቁ።
            ...
            <div class="row">
                  ...
                  <div class="card">
                                                        <div class="card-header"><strong class="card-title pl-2">ያለቁ ትዕዛዞች መፈለጊያ </strong> <small><span class="badge badge-danger float-right mt-1"> አጠቃላይ የተላኩ ትዕዛዞች ብዛት: <asp:Label ID="Labelordcount" runat="server" Text=" "></asp:Label></span></small>
</div>
                                                        <div class="card-body card-block">
                                                            <div class="row form-group">
                                                                    <div class="input-group">
                                                                        
                                                                       <div class="col col-md-6"> <asp:TextBox ID="TextBoxOrderId"  CssClass="form-control-sm form-control" Placeholder="የትዕዛዝ መለያ አስገባ" runat="server"></asp:TextBox></div>
                                                                        <div class="col col-md-3">
                                                                             <asp:Button ID="ButtonsrchFinord" runat="server"  class="btn btn-primary btn-sm btn-block" Text="ያለቀ ትዕዛዝ ፈልግ" OnClick="searchFinord" />

                                                                        </div>
                                                                        <div class="col col-md-3">
                                                                             <asp:Button ID="Buttonnewsearch" runat="server"  class="btn btn-primary btn-sm btn-block" Text="ሁሉንም ትዕዛዝ አሳይ" OnClick="searchNew" />
         ...
         <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2">ያለቁ ትዕዛዞች ዝርዝር</strong> <small><span class="badge badge-danger float-right mt-1"> አጠቃላይ ያለቁ ትዕዛዞች ብዛት: <asp:Label ID="LabeltotalFinOrders" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block" style="overflow:auto; width:1000px; height:auto">
                                    
                                     <asp:GridView ID="GridViewFinOrders" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="4" OnPageIndexChanging="LoadFinOrdpage" OnSelectedIndexChanged="SeeandSendFinOrder" AllowPaging="True" OnRowDataBound="width"  width="1250px" >


                                         <Columns>
                                             <asp:CommandField ShowSelectButton="True" SelectText="ላክ">
