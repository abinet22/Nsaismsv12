<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABankAccount.aspx.cs" Inherits="SGIMSIMS.ABankAccount" %>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
              ...
              <div class="card bg-secondary">
                       ...
                       <asp:Button ID="Buttaddbankacct" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Create Bank Account" OnClick="showaddacct" />
                    </div>
                           <div class="col-lg-3">
                       
                            <asp:Button ID="Butushowacctrans" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Bank Transaction" OnClick="showbanktrans" />
                    </div>
                                 <div class="col-lg-3"> </div>
                                     </div>
             ...
             <div class="col-md-8 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Add Bank Account <small><span class="badge badge-success float-right mt-1">Add Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                                                           <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Account ID</label></div>
                                                                <div class="col-12 col-md-5">
                                                                    <asp:TextBox ID="TextBoxbaccid" runat="server" placeholder="Enter Account ID..." class="form-control-sm form-control" Enabled="False"></asp:TextBox>
                                                                    </div>
                                                               <div class="col-12 col-md-4">
                                                                    <asp:Button ID="Buttongenbaccid"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="BankAccount ID" OnClick="BankAccountgenID"  />        
                                                               ...
                                                               <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9">
                                                                    <asp:TextBox ID="TextBoxbankname" runat="server" placeholder="Enter Bank Name..." class="form-control-sm form-control"></asp:TextBox>
                                                                   </div>
                                                            </div>
                                                           <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Bank Branch Name</label></div>
                                                                <div class="col-12 col-md-9">
                                                                    <asp:TextBox ID="TextBoxbrachname" runat="server" placeholder="Enter Bank Branch Name..." class="form-control-sm form-control"></asp:TextBox>
                                                                   </div>
                                                            </div>
                                                             <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Account Head</label></div>
                                                                <div class="col-12 col-md-9">
                                                                  <asp:DropDownList ID="DropDownListacchead" Cssclass="form-control-sm  form-control" runat="server" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" >
                                                                       <asp:ListItem Value="0">--Select Account Head--</asp:ListItem>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9">
                                                                  <asp:DropDownList ID="DropDownListaccttype" Cssclass="form-control-sm  form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" runat="server">
                               ...
                               <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Holder Name</label></div>
                                                                <div class="col-12 col-md-9">
                                                                     <asp:TextBox ID="TextBoxholrname" runat="server" placeholder="Enter Account Holder Name..." class="form-control-sm form-control"></asp:TextBox>
                               ...
                               <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9">
                                                                     <asp:TextBox ID="TextBoxacctno" runat="server" placeholder="Enter Account Number..." class="form-control-sm form-control"></asp:TextBox>
                                                                
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Opening Balance</label></div>
                                                                <div class="col-12 col-md-9">
                                                                     <asp:TextBox ID="TextBoxopbalnce" runat="server" placeholder="Enter Opening Balance..." class="form-control-sm form-control"></asp:TextBox>
                                                           ...
                                                           <asp:Button ID="Buttonaddbacct"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Add" OnClick="AddBacct"  />        
                                                         
                                                                    
                                                                </div>
                                                               <div class="col-12 col-md-3">
                                                             <asp:Button ID="Buttondlrbacct"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Delete" OnClick="Dlbacct"  />        
                                                                </div>
                                                               <div class="col-12 col-md-3">
                                                                </div>
                                                            </div>
                 ...
                 <div id ="showaccttrans" runat="server">
                    ...
                    <div class="col-md-8 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            <div class="card-body text-secondary">
                                  <div class="card">
                                                        <div class="card-header">Search Account Transactions</div>
                                                        <div class="card-body card-block">
                                                            <div class="row form-group">
                    ...
                    <small class="text-muted text-uppercase font-weight-bold">የመጨረሻ ቀን</small> 
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col col-md-4"><label for="hf-password" class=" form-control-label">Sales Manager Name</label></div>
                                                                <div class="col-12 col-md-4">
                                                           ...
                                                           <div class="row form-group">
                                                                <div class="col col-md-3">
                                                         <asp:Button ID="Buttaddpmat"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="DAY SUMMERY" OnClick="searchalltrans"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttvatq"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="GROUP BY AccountHolder" OnClick="searchtransbyah"  />        
                                                             
                                                                </div>
                                                               
                                                              
                                                               <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttonpayttye"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="GROUP BY BankName" OnClick="searchtransbybn"  />        
                                                             
                                                                </div>
                                                                 <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttsaleperson"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="GROUP BY SalePerson" OnClick="searchtransbysaleper"  />        
                ...
                <div class="col-lg-12">
                        ...
                        <section  class="card">
                            <div class="card-header">
                                <strong class="card-title"> <asp:Label ID="Labelheader" runat="server" Text="Label"></asp:Label><small><span class="badge badge-success float-right mt-1">Total Account
                                    <asp:Label ID="Labeltotalserv" runat="server" Text="Label"></asp:Label> </span></small></strong>
                          
                                </div>
                            <div class="card-body card-block">
                                <asp:GridView ID="GridViewbankacctlst" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="6" OnPageIndexChanging="newserlistpage" OnSelectedIndexChanged="selectandeditser" AllowPaging="True" >
