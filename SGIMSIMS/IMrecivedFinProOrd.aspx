<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IMrecivedFinProOrd.aspx.cs" Inherits="SGIMSIMS.IMrecivedFinProOrd" %>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                        ...
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Recieve Finish Product</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            ...
            <div class="row">
                  ...
                  <div class="card">
                                                        <div class="card-header"> የስራ መለያ በማስገባት ትዕዛዙን ይፈልጉ
                                                             <small><span class="badge badge-danger float-right mt-1"> ዛሬ ቀን፡ <asp:Label ID="Labeltoday" runat="server" Text=" "></asp:Label></span></small>
                                                        </div>
                                                        <div class="card-body card-block">
                                                            <div class="row form-group">
                                                                    <div class="input-group">
                                                                        
                                                                       <div class="col col-md-6"> <asp:TextBox ID="TextBoxMWorkId"  CssClass="form-control-sm form-control" Placeholder="የስራ መለያ" runat="server"></asp:TextBox></div>
                                                                        <div class="col col-md-3">
                                                                             <asp:Button ID="Buttonsrchwrkord" runat="server"  class="btn btn-primary btn-sm btn-block" Text="ፈልግ" OnClick="searchwrkord" />

                                                                        </div>
                                                                        <div class="col col-md-3">
                                                                             <asp:Button ID="Buttonnewsearch" runat="server"  class="btn btn-primary btn-sm btn-block" Text="አዲስ ፍለጋ" OnClick="searchNew" />
         ...
         <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2">የስራዎች ዝርዝር</strong> <small><span class="badge badge-danger float-right mt-1">አጠቃላይ የስራዎች ብዛት: <asp:Label ID="LabeltotalWorkOrders" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block" style="overflow:auto; width:1000px; height:auto">
                                    
                                     <asp:GridView ID="GridViewWorkOrders" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="4" OnPageIndexChanging="LoadWorkOrdpage" OnSelectedIndexChanged="SeeandRecFinOrder" AllowPaging="True" OnRowDataBound="width"  width="1450px">
