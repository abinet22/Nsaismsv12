<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMSend.aspx.cs" Inherits="SGIMSIMS.SMSend" %>
                ...
                <div class="page-header float-right">
                        ...
                        <ol class="breadcrumb text-right">
                            ...
                            <li >Sales Manager Admin</li>
                             <li class="active">Send RowMaterial</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
           ...
           <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Success</span> ፈቃድ ያገኙ የጥሬ ዕቃ መጠይቆች ዝርዝር በመመልከት መላክ ይችላሉ።
              ...
              <div class="row">
                  ...
                  <div class="card">
                                                        <div class="card-header">የጥሬ ዕቃ መላኪያ ፎርም</div>
                                                        <div class="card-body card-block">
                                                           <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label5" runat="server" Text="መጠይቅ መለያ"></asp:Label>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxreqid" placeholder="መጠይቅ መለያ"  Cssclass="form-control-sm form-control" runat="server" Enabled="False"></asp:TextBox>
                                                          ...
                                                          <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label6" runat="server" Text="የሚላክበት ቦታ"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                            <asp:TextBox ID="TextBoxwarehouseto" placeholder="የሚላክበት ቦታ"  Cssclass="form-control-sm form-control" runat="server" Enabled="False"></asp:TextBox>
                                                               ...
                                                               <div class="col-2"></div>
                                                               <div class="col-8"> 
                                                                   <asp:Button ID="Buttonsendrm" class="btn btn-secondary btn-sm btn-block" runat="server" Text="የጥሬ ዕቃ ላክ" OnClick="sendrm" Visible="False" /></div>
                                                               <div class="col-2"></div>
               ...
               <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2">ፈቃድ ያገኙ የጥሬ ዕቃ መጠይቆች ዝርዝር</strong> <small><span class="badge badge-danger float-right mt-1">ፈቃድ ያገኙ የጥሬ ዕቃ መጠይቆች ብዛት: <asp:Label ID="totalapptransfer" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block">
                                    
                                     <asp:GridView ID="GridViewReqList" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="4"  AllowPaging="True" OnSelectedIndexChanged="viewdtlsndrmreq"  >
