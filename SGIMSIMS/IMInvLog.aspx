<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IMInvLog.aspx.cs" Inherits="SGIMSIMS.IMInvLog" %>
            ...
            <div class="col-md-9 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                           ...
                           <div class="card-body card-block">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">የጥሬ እቃ ስም</label></div>
                                                                <div class="col-12 col-md-9">
