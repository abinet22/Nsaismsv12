<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ASndRowMat.aspx.cs" Inherits="SGIMSIMS.ASndRowMat" %>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
             ...
             <div class="row">
                  ...
                  <div class="card">
                                                        <div class="card-header">Row Material Request Item Detail</div>
                                                        <div class="card-body card-block">
                                                           <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label5" runat="server" Text="Request_ID"></asp:Label>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxreqid" placeholder="Row-Material Request_ID"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>

                                                                   </div></div>
                                                             <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label7" runat="server" Text="Request_BY"></asp:Label>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxrecby" placeholder="Row-Material Request_BY"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>

                                                                   </div></div>
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label4" runat="server" Text="Selected Row-Material Brand"></asp:Label>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxbrand" placeholder="Row-Material Brand"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>

                                                                   </div></div>
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label3" runat="server" Text="Selected Row-Material Gage"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                         <asp:TextBox ID="TextBoxgage" placeholder="Row-Material Gage"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
    
                                                               </div></div>
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label1" runat="server" Text="Row-Material Width"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6"><asp:TextBox ID="TextBoxrmwidth" placeholder="Row-Material Width" Cssclass="form-control-sm form-control" runat="server"></asp:TextBox></div>
                                                                   
                                                               </div>
                                                              <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label2" runat="server" Text="Row-Material Length"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                             <asp:TextBox ID="TextBoxrmlength" placeholder="Row-Material Length"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                               ...
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label8" runat="server" Text="Request Date"></asp:Label>
                                                                         ...
                                                                         <div class="col-6">
                                                                             <asp:TextBox ID="TextBoxrecdate" placeholder="Row-Material Request Date"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                          ...
                                                          <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label6" runat="server" Text="Select Shop "></asp:Label>
                                                                         ...
                                                                         <div class="col-6">
                                                                              <asp:DropDownList ID="DropDownrmwarehouse" class="form-control-sm form-control" runat="server" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" OnSelectedIndexChanged="showavilableqty"></asp:DropDownList>
                                                               <small class="form-text text-muted">Avalilable Quantity Of This Product In Selected Shop is </small><code>
                                                                   <asp:Label ID="Labelavalqty" runat="server" cssclass="control-label mb-1" Text="" Visible="False"></asp:Label></code>
                                                                         </div>
                                                               ...
                                                               <div class="col-4"></div>
                                                               <div class="col-4"> 
                                                                   <asp:Button ID="Buttonarovermreq" class="btn btn-secondary btn-sm btn-block" runat="server" Text="Approve Request" OnClick="approvermrequest" />

                                                               </div>
                                                               <div class="col-4">
                                                                      <asp:Button ID="Buttdltreqrm" class="btn btn-secondary btn-sm btn-block" runat="server" Text="Delete Request" OnClick="dltrmrequest" />
               ...
               <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2">RowMaterial Request List</strong> <small><span class="badge badge-danger float-right mt-1">Total Request: <asp:Label ID="Labeltotalreq" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block">
                                    
                                     <asp:GridView ID="GridViewReqList" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="4"  AllowPaging="True" OnSelectedIndexChanged="viewrequestlst" OnPageIndexChanging="loadnxtsnndrmpage"  >


                                         <Columns>
                                             <asp:CommandField ShowSelectButton="True" SelectText="See Detail">
