<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="SGIMSIMS.admin" %>
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Success</span><asp:Label ID="Labelmsg" runat="server" Text="Label"> You successfully read this important alert message.</asp:Label>
                   
                </div>
            </div>


           <div class="col-sm-12" id="divMessageexreq" runat="server" style="display:none; visibility:hidden">
                <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Alert</span> 
                     <asp:Label ID="Labelexreq" class="card-title" runat="server" Text=" "></asp:Label>
                    የወጪ መጠይቆች ተልከዋል። ዝርዝሩን በመመልከት መልስ ይስጡ።  
             ...
             <div class="col-sm-12" id="divMessagermreq" runat="server" style="display:none; visibility:hidden">
                <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Alert</span> 
                     <asp:Label ID="Labelrmreq" class="card-title" runat="server" Text=" "></asp:Label>
                    የጥሬ ዕቃ አቅርቦት መጠይቆች ተልከዋል። ዝርዝሩን በመመልከት መልስ ይስጡ።   
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
             ...
             <div class="col-sm-12" id="divMessagermlost" runat="server" style="display:none; visibility:hidden">
                <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Alert</span> የ
                     <asp:Label ID="Labelrmlost" class="card-title" runat="server" Text=" "></asp:Label>
          ...
          <div class="col-sm-12" id="divMessagepmplost" runat="server" style="display:none; visibility:hidden">
                <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Alert</span> የ
                     <asp:Label ID="Labelpmplost" class="card-title" runat="server" Text=" "></asp:Label>
              ...
              <div class="col-sm-12" id="divMessagepplost" runat="server" style="display:none; visibility:hidden">
                <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Alert</span> የ
                     <asp:Label ID="Labelpplost" class="card-title" runat="server" Text=" "></asp:Label>
             ...
             <div class="col-sm-12" id="creditduedt" runat="server" style="display:none; visibility:hidden">
                <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Alert</span> 
                     <asp:Label ID="Labelduecdt" class="card-title" runat="server" Text=" "></asp:Label>
                    በቅርብ ቀናት የሚከፈሉ ወጪዎች ስላሉ ዝርዝሩን በመመልከት ይዘጋጁ።  
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
