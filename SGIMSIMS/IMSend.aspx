<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IMSend.aspx.cs" Inherits="SGIMSIMS.IMSend" %>
...
<body>
 ...
 <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Success</span> ለመላክ ፍቃድ ያግኙ የጥሬ ዕቃዎች ዝርዝር። እናክዎት ዝርዝሩን በማየት ዕቃዎችን ያስተላልፉ።
                  ...
                  <div class="card">
                                                        ...
                                                        <div class="card-body card-block">
                                                           <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label5" runat="server" Text="የጥሬ ዕቃ መጠየቂያ መለያ"></asp:Label>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxreqid" placeholder="የጥሬ ዕቃ መጠየቂያ መለያ"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                               ...
                                                               <div class="row form-group">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxbrand" placeholder="የጥሬ ዕቃ ስም"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                               ...
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label3" runat="server" Text="የጥሬ ዕቃ ጌጅ"></asp:Label>
                                                                         ...
                                                                         <div class="col-6">
                                                                         <asp:TextBox ID="TextBoxgage" placeholder="የጥሬ ዕቃ ጌጅ"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                              ...
                                                              <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label2" runat="server" Text="የጥሬ ዕቃ ርዝመት"></asp:Label>
                                                                         ...
                                                                         <div class="col-6">
                                                                             <asp:TextBox ID="TextBoxrmlength" placeholder="የጥሬ ዕቃ ርዝመት"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                          ...
                                                          <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label6" runat="server" Text="የሚላክለት ሰራተኛ ስም"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                            <asp:TextBox ID="TextBoxwarehouseto" placeholder="የሚላክለት ሰራተኛ ስም"  Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                               ...
                                                               <div class="col-2"></div>
                                                               <div class="col-8"> 
                                                                   <asp:Button ID="Buttonsendrm" class="btn btn-secondary btn-sm btn-block" runat="server" Text="ጥሬ ዕቃ ላክ" OnClick="sendrm" /></div>
                                                               <div class="col-2"></div>
               ...
               <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2">ለመላክ ፍቃድ ያግኙ የጥሬ ዕቃዎች ዝርዝር</strong> <small><span class="badge badge-danger float-right mt-1">የጥሬ ዕቃዎች ዝርዝር ብዛት: <asp:Label ID="totalapptransfer" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block">
                                    
                                     <asp:GridView ID="GridViewReqList" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="4"  AllowPaging="True" OnSelectedIndexChanged="viewdtlsndmat" OnPageIndexChanging="loadnextrmsentpage"  >
