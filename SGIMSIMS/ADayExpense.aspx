<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADayExpense.aspx.cs" Inherits="SGIMSIMS.ADayExpense" %>
   ...
   <aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
                                                            ...
                                                            <div class="row form-group">
                                                                    <div class="input-group">
                                                                       ...
                                                                       <div class="col col-md-3"> 
                                                                        ...
                                                                        <div class="col col-md-6">
                                                                             <asp:Button ID="Buttstat" runat="server"  class="btn btn-primary btn-sm btn-block" Text="Load Stastics" OnClick="Binschart"  />
            ...
            <div class="row">
                <div class="col-6">
                    <asp:Chart ID="Chart1" runat="server"   Height="460px" Width="480px" >
                        <Titles>
                        ...
                        <Series>
                            <asp:Series Name="Sale Revenue By Payment Type"></asp:Series>
                        </Series>
                        <ChartAreas>
                 ...
                 <div class="col-6">
                    <asp:Chart ID="Chart2" runat="server" Height="460px" Width="480px" >
                        <Titles>
                            <asp:Title ShadowOffset="10" Name="Most Sale Products"></asp:Title>
                        ...
                        <Series>
                            <asp:Series Name="Sale Revenue Of Each Shop"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1" BorderWidth="0"></asp:ChartArea>
                        </ChartAreas>
                   ...
                   <div class="col-6">
                    <asp:Chart ID="Chart3" runat="server"  Height="460px"  Width="480px" >
                        <Titles>
                            <asp:Title ShadowOffset="10" Name="Most Sale Products"></asp:Title>
                        ...
                        <Series>
                            <asp:Series Name="Row Material Quantity Sold"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1" BorderWidth="0"></asp:ChartArea>
                        </ChartAreas>
                   ...
                   <div class="col-6 chart">
                    <asp:Chart ID="Chart4" class="chart-canvas" runat="server"  Height="460px" Width="480px" >
                        <Titles>
                            <asp:Title ShadowOffset="10" Name="Most Sale Products"></asp:Title>
                        ...
                        <Series>
                            <asp:Series Name="Daily Sale Revenue"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1" BorderWidth="1"></asp:ChartArea>
                        </ChartAreas>
                    </asp:Chart>
