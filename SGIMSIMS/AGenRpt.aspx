<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AGenRpt.aspx.cs" Inherits="SGIMSIMS.AGenRpt" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Periodic Sale Report</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
              ...
              <div class="card bg-secondary">
                       ...
                       <asp:Button ID="Buttperdrpt" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Show Peridic Report" OnClick="showperrpt" />
                    </div>
                           <div class="col-lg-3">
                       
                            <asp:Button ID="Butcrdtrpt" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Show Credit Report" OnClick="showcdtrpt" />
                    </div>
                                 <div class="col-lg-3"> </div>
                                     </div>
                ...
                <div id="showcrdrpt" runat="server">
                        <div class="row">
            ...
            <div class="col-md-9 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Search Peridic Credit Log<small><span class="badge badge-success float-right mt-1">Add Parameter Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                                       ...
                                       <div class="row form-group">
                                                                <div class="col col-md-6">
                                                                 <asp:TextBox ID="TextBoxcrdfrom" runat="server"  class="form-control-sm form-control" TextMode="Date"></asp:TextBox>
                                                          <small class="text-muted text-uppercase font-weight-bold">የመጀመሪያ ቀን</small>                                                                </div>
                                                                <div class="col-12 col-md-6">
                                                                    <asp:TextBox ID="TextBoxcrdto" runat="server"  class="form-control-sm form-control" TextMode="Date"></asp:TextBox>
                    <small class="text-muted text-uppercase font-weight-bold">የመጨረሻ ቀን</small> 
                                                           ...
                                                           <div class="row form-group">
                                                                ...
                                                                <div class="col col-md-6">
                                                         <asp:Button ID="Buttcrdpts"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="SEARCH" OnClick="searchcrdrpt"  />        
                      ...
                      <div class="col-lg-12">
                        ...
                        <section  class="card">
                            <div class="card-header">
                                <strong class="card-title">All Credit Sales List<small><span class="badge badge-success float-right mt-1">Total Credit Sale
                                    <asp:Label ID="Labeltotalcrd" runat="server" Text="Label"></asp:Label> </span></small></strong>
                          
                                </div>
                            <div class="card-body card-block">
                                <asp:GridView ID="GridViewcrdrpt" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="10" OnPageIndexChanging="newcrdrptpage"  AllowPaging="True" >
                ...
                <div id="showpeidrrpt" runat="server">
        <div class="row">
            ...
            <div class="col-md-9 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            <div class="card-body text-secondary">
                                 <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Search Peridic Shop Log<small><span class="badge badge-success float-right mt-1">Add Parameter Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                    ...
                    <small class="text-muted text-uppercase font-weight-bold">የመጨረሻ ቀን</small> 
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-4">
                                                                  <asp:DropDownList runat="server" ID="DropDownListwarehouse"  cssclass="form-control-sm is-invalid form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" OnSelectedIndexChanged="loadusername">
                                                                        </asp:DropDownList>
                                         ...
                                         <div class="row form-group">
                                               <div class="col-12 col-md-2">
                                                                ...
                                                                <div class="col col-md-4"><label for="hf-password" class=" form-control-label">Sales Person Name</label></div>
                                                                <div class="col-12 col-md-4">
                                                                  <asp:DropDownList runat="server" ID="DropDownListsmname"  cssclass="form-control-sm is-invalid form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" >
                                                                        </asp:DropDownList>
            ...
            <div class="card col-md-6 no-padding ">
             ...
             <div class="card col-md-6 no-padding ">
                <div class="card-body">
                    ...
                    <div class="h4 mb-0">
                        <asp:Label ID="Labelnoordsale" runat="server" Text="Label"></asp:Label><small class="text-muted"> , </small> <asp:Label ID="Labelnosalecount" runat="server" Text="Label"></asp:Label> 
                    </div>
