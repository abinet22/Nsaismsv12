<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ACrtSysUsr.aspx.cs" Inherits="SGIMSIMS.ACrtSysUsr" %>
...
<form runat="server">
 ...
 <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Add System Users <small><span class="badge badge-success float-right mt-1">Add Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                                                           <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-email" class=" form-control-label">UserID</label></div>
                                                              
                                                                <div class="col-12 col-md-5">
                                                                      <asp:TextBox ID="TextBoxusrid" runat="server" placeholder="Enter User ID..." class="form-control-sm form-control"></asp:TextBox>
                                                            
                                                                    </div>
                                       <div class="col col-md-4 ">
                                               <asp:Button ID="Buttproid"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Add User ID" OnClick="Genproductid"  />        
                                                             ...
                                                             <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9">
                                                                          <asp:TextBox ID="TextBoxusrname" runat="server" placeholder="Enter User Name..." class="form-control-sm form-control"></asp:TextBox>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9">
                                                                     <asp:TextBox ID="TextBoxpassword" runat="server" placeholder="Enter User Password..." class="form-control-sm form-control"></asp:TextBox>
                                                             
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">UserRoll</label></div>
                                                                <div class="col-12 col-md-9">
                                                                    <asp:DropDownList runat="server" ID="DropDownListuroll"  cssclass="form-control-sm is-invalid form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" >

                                                                        <asp:ListItem Text="--Select User Roll--" Value="0"></asp:ListItem>                                      
                                                                                 <asp:ListItem Text="Sales Manager" Value="1"></asp:ListItem>
                                                                               <asp:ListItem Text="Inventory Manager" Value="2"></asp:ListItem>
                                                                        <asp:ListItem Text="Admin" Value="3"></asp:ListItem>
                                                                                  </asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">AssignShop</label></div>
                                                                <div class="col-12 col-md-9">
                                                                    <asp:DropDownList runat="server" ID="DropDownListshoplst"  cssclass="form-control-sm is-invalid form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True">
                                                                        </asp:DropDownList>
                                     ...
                                     <div class="col col-md-6">
                                        ...
                                        <asp:CheckBox  runat="server" ID="CheckBoxattach"  Text="Is Admin?" />
                            </label>
                                     ...
                                     <div class="col col-md-2"></div>
                                                           ...
                                                           <div class="row form-group">
                                                                <div class="col col-md-4">
                                                         <asp:Button ID="Buttonaddusr"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Add" OnClick="addusr"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-4">
                                                             <asp:Button ID="Buttonudtusr"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Update" OnClick="udtusr"  />        
                                                                </div>
                                                               <div class="col-12 col-md-4">
                                                             <asp:Button ID="Buttondltusr"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Delete" OnClick="dltusr"  />        
                                                                </div>
                                                            </div>
                                                    </div>
                 ...
                 <div class="col-lg-12">
                        ...
                        <section  class="card">
                            <div class="card-header">
                                <strong class="card-title">System User List <small><span class="badge badge-success float-right mt-1">Info</span></small></strong>
                          
                                </div>
                            <div class="card-body card-block">
                               
                                <asp:GridView ID="GridViewUsrLst" runat="server" Cssclass="table table-striped" PageSize="4" OnPageIndexChanging="Loadsysusrpage" OnSelectedIndexChanged="Loadsysuserlst" AllowPaging="True">
