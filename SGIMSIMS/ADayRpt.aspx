<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADayRpt.aspx.cs" Inherits="SGIMSIMS.ADayRpt" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Daily Shop Report</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-9 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Search Daily Report By Shop<small><span class="badge badge-success float-right mt-1">Add Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-6">
                                                                  <asp:DropDownList runat="server" ID="DropDownListwarehouse"  cssclass="form-control-sm is-invalid form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" OnSelectedIndexChanged="loadallalesname">
                                                                        </asp:DropDownList>
                              
                                                                </div>
                                                            </div>
                              <div class="row form-group">
                                                                <div class="col col-md-6"><label for="hf-password" class=" form-control-label">Sales Person Name</label></div>
                                                                <div class="col-12 col-md-6">
                ...
                <div class="card ">
                    <div class="card-body">
                       ...
                       <small class="text-muted text-uppercase font-weight-bold">ክሬዲት</small>
                                  ...
                                  <small class="text-muted text-uppercase font-weight-bold">Additional Revenue </small>
                                  <div class="h4 mb-0">
                                                   <span class="count"><asp:Label ID="Labeladdrev" runat="server" Text="Label"></asp:Label></span>
                    </div>
                            </div>
                        </div>
                    </div>
