<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARevenueList.aspx.cs" Inherits="SGIMSIMS.ARevenueList" %>
    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Dashboard</li>
                             ...
                             <li class="active">Revenue And Expense</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
              ...
              <div class="card bg-secondary">
                       ...
                       <asp:Button ID="Buttshowrevenuerpt" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Revenue Report" OnClick="showrevrpt" />
                    </div>
                           <div class="col-lg-3">
                       
                            <asp:Button ID="Butudexpenserpt" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Expense Report" OnClick="showexprpt" />
                    </div>
                                 <div class="col-lg-3"> </div>
                                     </div>
                    ...
                    <div class="col-md-8 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            <div class="card-body text-secondary">
                                  <div class="card">
                                                        <div class="card-header">Search Revenue Report</div>
                    ...
                    <small class="text-muted text-uppercase font-weight-bold">የመጨረሻ ቀን</small> 
                                                           ...
                                                           <div class="row form-group">
                                                                 <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttgpshop"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="GROUP BY SHOP" OnClick="searchbyShop"  />        
                                                             
                                                                </div>
                                                                <div class="col col-md-3">
                                                         <asp:Button ID="Buttaddpmat"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="DAY SUMMERY" OnClick="search"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttvatq"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="GROUP BY VAT?" OnClick="searchbyVAT"  />        
                                                            ...
                                                            <div class="row form-group">
                                                               ...
                                                               <div class="col-12 col-md-4">
                                                                    <asp:Button ID="Buttexprev"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Export Sale Revenue List" OnClick="exportrevlst"  />        
                   ...
                   <div class="row">
                    <div class="col-md-8 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            <div class="card-body text-secondary">
                                  <div class="card">
                                                        <div class="card-header">Search Expense Report</div>
                                                        <div class="card-body card-block">
                                                            <div class="row form-group">
                                                                <div class="col col-md-6">
                    ...
                    <small class="text-muted text-uppercase font-weight-bold">የመጨረሻ ቀን</small> 
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col col-md-4"><label for="hf-password" class=" form-control-label">Sales Manager Name</label></div>
                                                                <div class="col-12 col-md-4">
                                                                  <asp:DropDownList runat="server" ID="DropDowwarehome"  cssclass="form-control-sm is-invalid form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True">
                                                                        </asp:DropDownList>
                                                           ...
                                                           <div class="row form-group">
                                                                <div class="col col-md-3">
                                                         <asp:Button ID="Buttexall"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="DAY SUMMERY" OnClick="searchexp"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttexcata"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="GROUP BY CATAGORY" OnClick="searchbyCAT"  />        
                                                             
                                                                </div>
                                                               
                                                              
                                                               <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Butexness"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="GROUP BY NECESSITY" OnClick="searchBYnes"  />        
                                                             
                                                                </div>
                                                                 <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Butallexp"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="List All Expense" OnClick="searchallexplst"  />        
                                                       ...
                                                       <div class="row form-group">
                                                               ...
                                                               <div class="col-12 col-md-4">
                                                                    <asp:Button ID="Buttexpoortexplst"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Export Expense List" OnClick="exportexplst"  />        
            ...
            <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2"><asp:Label ID="Labelnoteheader" runat="server" Text=" "></asp:Label></strong> <small><span class="badge badge-danger float-right mt-1">Total Amount: <asp:Label ID="Labeltotrev" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block">
                                    
                                     <asp:GridView ID="GridViewSaleRevList" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="31"  AllowPaging="True" OnPageIndexChanging="loadsalerevlitpage"  >
