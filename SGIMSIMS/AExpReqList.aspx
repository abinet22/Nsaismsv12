<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AExpReqList.aspx.cs" Inherits="SGIMSIMS.AExpReqList" %>
                    ...
                    <div class="col-md-8 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            <div class="card-body text-secondary">
                                       <div class="card">
                                                        <div class="card-header">የተጠየቀ ወጪ ፎርም</div>
                                                        <div class="card-body card-block">
                                                            <div class="row form-group">
                                                                    <div class="input-group">
                                                                        <div class="col-6"><asp:Label ID="Label5" runat="server" Text="የመጠይቅ መለያ"></asp:Label></div>
                                                                       <div class="col col-md-6"> <asp:TextBox ID="TextBoxexprecId" enabled= "false" CssClass="form-control-sm form-control" Placeholder="የመጠይቅ መለያ" runat="server"></asp:TextBox></div>
                                                      ...
                                                      <div class="col col-md-6"> <asp:TextBox ID="TextBoxexpreason" enabled= "false" CssClass="form-control-sm form-control" Placeholder="የወጪ ምክንያት" runat="server"></asp:TextBox></div>
                                                              ...
                                                              <div id="Div1" runat="server">
                                                                <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label7" runat="server" Text="የወጪ ኣይነት"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                  <asp:TextBox ID="TextBoxexptype" placeholder="የወጪ ኣይነት" Cssclass="form-control-sm form-control"  runat="server"></asp:TextBox>
                                                         ...
                                                         <div id="empslaexp" runat="server">
                                                               ...
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label3" runat="server" Text="የሰራተኛ ስም"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                    <asp:TextBox ID="TextBoxempname" placeholder="የሰራተኛ ስም" Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                                ...
                                                                <div class="col-3">
                                                                       ...
                                                                       <small class="form-text text-muted"><code>የደምዝ አከፋፈል ሁኔታ</code></small>
                                                                    </div>
                                                                    <div class="col-3">
                                         ...
                                         <small class="form-text text-muted"><code>ቅድመ ክፍያ ካለ?</code>
                                                             ...
                                                             <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label6" runat="server" Text="ወጪውን የጠየቀው"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                             <asp:TextBox ID="TextBoxreqby" placeholder="ወጪውን የጠየቀው" Cssclass="form-control-sm form-control" runat="server"></asp:TextBox>
                                                              ...
                                                              <div class="row form-group">
                                                               ...
                                                               <div class="col-4"></div>
                                                               <div class="col-4"> 
                                                                   <asp:Button ID="Buttonacceptrequest" class="btn btn-secondary btn-sm btn-block" runat="server" Text="ወጪውን ፍቀድ" OnClick="confirmxprequest" />

                                                               </div>
                                                               <div class="col-4">
                                                                     <asp:Button ID="Buttondltexpreq" class="btn btn-secondary btn-sm btn-block" runat="server" Text="ወጪውን ሰርዝ" OnClick="deltrmxprequest" />
               ...
               <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2">የተጠየቁ ወጪዎች ዝርዝር</strong> <small><span class="badge badge-danger float-right mt-1">የተጠየቁ ወጪዎች ብዛት: <asp:Label ID="LabelreqEmp" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block">
                                    
                                     <asp:GridView ID="GridViewReqList" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="8"  AllowPaging="True" OnSelectedIndexChanged="loadexpensereqdet" OnPageIndexChanging="newreqlstpage"  >
