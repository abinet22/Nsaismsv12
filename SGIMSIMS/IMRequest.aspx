<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IMRequest.aspx.cs" Inherits="SGIMSIMS.IMRequest" %>
...
<body>
                ...
                <div class="page-header float-right">
                        ...
                        <ol class="breadcrumb text-right">
                          <li><a href="#">Dashboard</a></li>
                            ...
                            <li class="active"> Request Material</li>
                        </ol>
                    </div>
                </div>
            </div>
 ...
 <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Success</span> አዲስ የጥሬ ዕቃ መጠየቂያ መለያ በመፍጠር የጥሬ ዕቃ ስምና ጌጅ መመምረጥና ርዝመቱን በሜትር በማስገባት ይላኡ።
                                                        ...
                                                        <div class="card-body card-block">
                                                            <div class="row form-group">
                                                                    <div class="input-group">
                                                                        <div class="col-4"><asp:Label ID="Label5" runat="server" Text="የመጠየቂያ መለያ"></asp:Label></div>
                                                                       <div class="col col-md-4"> <asp:TextBox ID="TextBoxMReqId" enabled= "false" CssClass="form-control-sm form-control" Placeholder="ዕቃ መጠየቂያ መለያ" runat="server"></asp:TextBox></div>
                                                                        <div class="col col-md-4">
                                                                             <asp:Button ID="ButtongenRmreqid" runat="server"  class="btn btn-primary btn-sm btn-block" Text="ዕቃ መጠየቂያ መለያ ፍጠር" OnClick="generateRequestid" />
                                                               ...
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label4" runat="server" Text="የጥሬ ዕቃ ስም ምረጥ"></asp:Label>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <asp:DropDownList ID="DropDownrmbrand" class="form-control-sm form-control" runat="server" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" OnSelectedIndexChanged="enableallbrgages"></asp:DropDownList>
                                                               ...
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label1" runat="server" Text="የጥሬ ዕቃ ስፋት አስገባ"></asp:Label>
                                                                    </div>
                                                              ...
                                                              <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label2" runat="server" Text="የጥሬ ዕቃ ርዝመት አስገባ"></asp:Label>
                                                                    </div>
                                                               ...
                                                               <div class="col-2"></div>
                                                               <div class="col-8"> 
                                                                   <asp:Button ID="Buttonsendrmrequest" class="btn btn-secondary btn-sm btn-block" runat="server" Text="ጥሬ ዕቃ መጠየቂያ ላክ" OnClick="sendrmrequest" /></div>
                                                               <div class="col-2"></div>
