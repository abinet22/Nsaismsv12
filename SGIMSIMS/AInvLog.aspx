<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AInvLog.aspx.cs" Inherits="SGIMSIMS.AInvLog" %>
        ...
        <div class="row">
            ...
            <div class="col-md-9 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                           ...
                           <div class="card-body card-block">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">ProductBrand</label></div>
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">ProductGage</label></div>
                                                                <div class="col-12 col-md-9">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Material Width</label></div>
                                                                <div class="col-12 col-md-9">
                                                                   <asp:TextBox ID="TextBoxmatwidth" runat="server" placeholder="Enter Material Width..." class="form-control-sm form-control"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="RegularExpreprosize" runat="server" ControlToValidate="TextBoxmatwidth" ErrorMessage="Enter Correct amount" ValidationExpression="^\d+([,\.]\d{1,2})?$"></asp:RegularExpressionValidator>   
                                                           ...
                                                           <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Material Length</label></div>
                                                                <div class="col-12 col-md-9">
                                                                      <asp:TextBox ID="TextBoxmatlength" runat="server" placeholder="Enter material Length..." class="form-control-sm form-control"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxmatlength" ErrorMessage="Enter Correct amount" ValidationExpression="^\d+([,\.]\d{1,2})?$"></asp:RegularExpressionValidator>   
                                                         ...
                                                         <asp:Button ID="Buttaddpmat"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Add" OnClick="addmatlst"  />        
                                                             
                                                                    </div>
                                                              
                                                               <div class="col-12 col-md-6">
                                                             <asp:Button ID="Buttdltmatdata"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Clear" OnClick="dltmatdatalst"  />        
                                                                </div>
                                                            </div>
                 ...
                 <div class="col-lg-12">
                        ...
                        <section  class="card">
                            <div class="card-header">
                                <strong class="card-title">Material List <small><span class="badge badge-success float-right mt-1">Total Products
