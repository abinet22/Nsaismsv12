<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AEmpTAPosn.aspx.cs" Inherits="SGIMSIMS.AEmpTAPosn" %>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="row">
             <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">RowMaterial Brand And Gage <small><span class="badge badge-success float-right mt-1">Add Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                                                           
                                                             <div class="row form-group">
                                                                <div class="col col-md-6"><label for="hf-email" class=" form-control-label">RowMaterial Brand Name</label></div>
                                                                <div class="col-12 col-md-6">
                                                                    <asp:TextBox ID="TextBoxbrand" class="form-control-sm form-control" runat="server"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                           <div class="row form-group">
                                                                <div class="col col-md-6"><label for="hf-email" class=" form-control-label">RowMaterial Gage</label></div>
                                                                <div class="col-12 col-md-6">
                                                                         <asp:TextBox ID="TextBoxgage" class="form-control-sm form-control" runat="server"></asp:TextBox>
                                                            
                                                                </div>
                                                            </div>
                                                           <div class="row form-group">
                                                                <div class="col col-md-4">
                                                         <asp:Button ID="Button7addbrandgage"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Add" OnClick="Button7addbrandgage_Click"  />        
                                                               ...
                                                               <div class="col-12 col-md-4">
                                                             <asp:Button ID="Buttondeletebrandgage"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Delete" OnClick="Buttondeletebrandgage_Click"  />        
                                                                </div>
                                                            </div>
                                                    </div>
             ...
             <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">RowMaterial Brands And Gage <small><span class="badge badge-success float-right mt-1">Info</span></small></strong>
                            </div>
                            <div class="card-body">
                               
                                <asp:GridView ID="GridViewrmbrandgage" runat="server" Cssclass="table table-striped" PageSize="6" OnPageIndexChanging="Loadbrandgagepage" OnSelectedIndexChanged="Loadbrandgagelst" AllowPaging="True"></asp:GridView>
                            </div>
                        </div>
                    </div>
            <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Add Product Shapes<small><span class="badge badge-success float-right mt-1">Add Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                                                           
                                                             <div class="row form-group">
                                                                <div class="col col-md-6"><label for="hf-email" class=" form-control-label">Product Shapes</label></div>
                                                                <div class="col-12 col-md-6">
                                   <asp:TextBox ID="TextBoxproshape" class="form-control-sm form-control" runat="server"></asp:TextBox>
                                                            
                                                                </div>
                                                            </div>
                                <div class="row form-group">
                                                                <div class="col col-md-6"><label for="hf-email" class=" form-control-label">Shapes Detail</label></div>
                                                                <div class="col-12 col-md-6">
                                   <asp:TextBox ID="TextBoxshapedetail" class="form-control-sm form-control" runat="server"></asp:TextBox>
                                                           ...
                                                           <div class="row form-group">
                                                                <div class="col col-md-4">
                                                         <asp:Button ID="Buttaddproshape"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Add" OnClick="addproshapes"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-4">
                                                                </div>
                                                               <div class="col-12 col-md-4">
                                                             <asp:Button ID="Buttondltproshape"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Delete" OnClick="btndltproshape"  />        
                                                                </div>
                                                            </div>
                                                    </div>
            ...
            <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Product Shapes <small><span class="badge badge-success float-right mt-1">Info</span></small></strong>
                            </div>
                            <div class="card-body">
                               
                                <asp:GridView ID="GridViewshapes" runat="server" Cssclass="table table-striped" PageSize="6" OnPageIndexChanging="Loadshapspage" OnSelectedIndexChanged="Loadproshapelst" AllowPaging="True"></asp:GridView>
                            </div>
                        </div>
                    </div>
