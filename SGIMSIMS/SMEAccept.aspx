<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMEAccept.aspx.cs" Inherits="SGIMSIMS.SMEAccept" %>
        ...
        <div class="content mt-3">
             ...
             <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Success</span> የተፈቀዱ የወጪዎች ዝርዝር እዚህ ማየት ይችላሉ።
           ...
           <div class="row">
                  ...
                  <div class="card">
                                                        <div class="card-header">የወጪ ዝርዝር</div>
                                                        <div class="card-body card-block">
                                                           <div class="row form-group">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxexpreqid" placeholder="የመጠይቅ መለያ"  Cssclass="form-control-sm form-control" runat="server" Enabled="false"></asp:TextBox>

                                                                   </div></div>
                                                             
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label4" runat="server" Text="የወጭ ምክንያት"></asp:Label>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <asp:TextBox ID="TextBoxexpreason" placeholder="የወጭ ምክንያት"  Cssclass="form-control-sm form-control" runat="server" Enabled="false"></asp:TextBox>

                                                                   </div></div>
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label3" runat="server" Text="የሚከፈለው "></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                         <asp:TextBox ID="TextBoxpaidto" placeholder="የሚከፈለው"  Cssclass="form-control-sm form-control" runat="server" Enabled="false"></asp:TextBox>
    
                                                               </div></div>
                                                               <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label1" runat="server" Text="የክፍያው መጠን"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6"><asp:TextBox ID="TextBoxpayamount" placeholder="የክፍያው መጠን" Cssclass="form-control-sm form-control" runat="server" Enabled="false"></asp:TextBox></div>
                                                              ...
                                                              <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label2" runat="server" Text="ተጨማሪ ማብራሪያ"></asp:Label>
                                                                         ...
                                                                         <div class="col-6">
                                                                             <asp:TextBox ID="TextBoxnote" placeholder="ተጨማሪ ማብራሪያ"  Cssclass="form-control-sm form-control" runat="server" Enabled="false"></asp:TextBox>
                                                          ...
                                                          <div class="row form-group">
                                                                    <div class="col-6">
                                                                        <asp:Label ID="Label6" runat="server" Text="የከፋዩ ስም"></asp:Label>
                                                                    </div>
                                                                         <div class="col-6">
                                                                            <asp:TextBox ID="TextBoxpaidby" placeholder="የከፋዩ ስም"  Cssclass="form-control-sm form-control" runat="server" Enabled="false"></asp:TextBox>
                                                               ...
                                                               <div class="col-2"></div>
                                                               <div class="col-8"> 
                                                                   <asp:Button ID="Buttonpay" class="btn btn-secondary btn-sm btn-block" runat="server" Text="ገንዘብ ወጪ አርግ" OnClick="withdrowmoney" Visible="False" /></div>
                                                               <div class="col-2"></div>
               ...
               <div class="col-lg-12">
                        ...
                        <section  class="card">
                            ...
                            <div class="card-header">
                                <i class="fa fa-shopping-cart"></i><strong class="card-title pl-2">ፍቃድ ያገኙ ወጪዎች ዝርዝር</strong> <small><span class="badge badge-danger float-right mt-1">ፍቃድ ያገኙ ወጪዎች ብዛት: <asp:Label ID="totalappexlst" runat="server" Text=" "></asp:Label></span></small>
                                
                            </div>
                            
                                 <div class="card-body card-block">
                                    
                                     <asp:GridView ID="GridViewAppExpenseList" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="4"  AllowPaging="True" OnSelectedIndexChanged="selectappexlistdetail" OnPageIndexChanging="nextexplstpage"  >


                                         <Columns>
                                             <asp:CommandField ShowSelectButton="True" SelectText="ዝርዝሩን አሳይ">
