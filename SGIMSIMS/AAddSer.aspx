<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AAddSer.aspx.cs" Inherits="SGIMSIMS.AAddSer" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">CreateService</li>
                        </ol>
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-9 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Add Service <small><span class="badge badge-success float-right mt-1">Add Here</span></small></strong>
                            </div>
                           <div class="card-body card-block">
                                                           <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-email" class=" form-control-label">ServiceID</label></div>
                                                                <div class="col-12 col-md-5">
                                                                    <asp:TextBox ID="TextBoxserid" runat="server" placeholder="Enter Service ID..." class="form-control-sm form-control" Enabled="False"></asp:TextBox>
                                                                    </div>
                                                               <div class="col-12 col-md-4">
                                                                    <asp:Button ID="Buttongenserid"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="አዲስ የሰርቪስ መለያ" OnClick="GeneserID"  />        
                                                          
                                                               </div>
                                                            </div>
                                                             
                                                             <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Product Type</label></div>
                                                                <div class="col-12 col-md-9">
                                                                  <asp:DropDownList ID="DropDownListprotype" Cssclass="form-control-sm  form-control" runat="server" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" OnSelectedIndexChanged="loadproducname">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9">
                                                                  <asp:DropDownList ID="DropDownListproname" Cssclass="form-control-sm  form-control" AppendDataBoundItems="True" ViewStateMode="Enabled" AutoPostBack="True" runat="server" OnSelectedIndexChanged="loadservicename"></asp:DropDownList>
                                                                    </div></div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">ServiceType</label></div>
                                                                <div class="col-12 col-md-9">
                                                                    <asp:DropDownList ID="DropDownListsertyp" CssClass="form-control-sm form-control" runat="server">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Service Name</label></div>
                                                                <div class="col-12 col-md-9">
                                                                    <asp:TextBox ID="TextBoxsername" runat="server" placeholder="Enter Service Name..." class="form-control-sm form-control" Enabled="False"></asp:TextBox>
                                                                   </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">ServicePrice</label></div>
                                                                <div class="col-12 col-md-9">
                                                                    <asp:TextBox ID="TextBoxserprce" runat="server" placeholder="Enter Service Price..." class="form-control-sm form-control"></asp:TextBox>
                                                                      <asp:RegularExpressionValidator ID="RegularExpreprosize" runat="server" ControlToValidate="TextBoxserprce" ErrorMessage="Enter Correct amount" ValidationExpression="^\d+([,\.]\d{1,2})?$"></asp:RegularExpressionValidator>   
                               ...
                               <div class="row form-group">
                                   ...
                                   <div class="col col-md-2"></div>
                                                         ...
                                                         <asp:Button ID="Buttonaddser"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Add" OnClick="Addservice"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-4">
                                                             <asp:Button ID="Buttonudtser"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Update" OnClick="Adtservice"  />        
                                                                </div>
                                                               <div class="col-12 col-md-4">
                                                             <asp:Button ID="Buttondlrser"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Delete" OnClick="DltService"  />        
                                                                </div>
                                                            </div>
                                                    </div>
                ...
                <div class="col-lg-12">
                        ...
                        <section  class="card">
                            <div class="card-header">
                                <strong class="card-title">Service List <small><span class="badge badge-success float-right mt-1">Total Service
                                    <asp:Label ID="Labeltotalserv" runat="server" Text="Label"></asp:Label> </span></small></strong>
                          
                                </div>
                            <div class="card-body card-block">
                                <asp:GridView ID="GridViewservicelst" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="6" OnPageIndexChanging="newserlistpage" OnSelectedIndexChanged="selectandeditser" AllowPaging="True" >
