<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AManEmployee.aspx.cs" Inherits="SGIMSIMS.AManEmployee" %>
        ...
        <div class="content mt-3">
             ...
             <div class="col-sm-12">
              <div class="card bg-secondary">
                       ...
                       <asp:Button ID="Buttmanageusr" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Manage Employee" OnClick="showmanusr" />
                    </div>
                           <div class="col-lg-3">
                       
                            <asp:Button ID="Butmanagper" runat="server" class="btn btn-secondary btn-sm btn-block" Text="Employee Performance" OnClick="showempper" />
                    </div>
                                 <div class="col-lg-3"> </div>
                                     </div>
                ...
                <div id ="showaccttrans" runat="server">
                    ...
                    <div class="col-md-8 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            <div class="card-body text-secondary">
                                  <div class="card">
                                                        <div class="card-header">Search Employee Work List</div>
                    ...
                    <small class="text-muted text-uppercase font-weight-bold">የመጨረሻ ቀን</small> 
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col col-md-4"><label for="hf-password" class=" form-control-label">Sales/Inventory Manager Name</label></div>
                                                         ...
                                                         <asp:Button ID="Buttaddpmat"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Ordered By" OnClick="searchorder"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttvatq"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Sold By" OnClick="searchsold"  />        
                                                             
                                                                </div>
                                                               
                                                              
                                                               <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttonpayttye"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="RM Accept By" OnClick="searchrmapt"  />        
                                                             
                                                                </div>
                                                                 <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Buttsaleperson"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="RM Sent By" OnClick="searchtrmsent"  />        
                                                             ...
                                                             <div class="row form-group">
                                                                <div class="col col-md-3">
                                                         <asp:Button ID="Button2"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Order Recive By" OnClick="searchorderrec"  />        
                                                             
                                                                    </div>
                                                                <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Button3"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Work Start By" OnClick="searchordsrt"  />        
                                                             
                                                                </div>
                                                               
                                                              
                                                               <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Button4"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Work Recived By" OnClick="searchwrkrec"  />        
                                                             
                                                                </div>
                                                                 <div class="col-12 col-md-3">
                                                                    <asp:Button ID="Button5"  runat="server" cssclass="btn btn-sm btn-info btn-block" Text="Work Sent By" OnClick="searchworksnt"  />        
                        ...
                        <section  class="card">
                            <div class="card-header">
                                <strong class="card-title"> <asp:Label ID="Labelheader" runat="server" Text="Label"></asp:Label></strong>
                          
                                </div>
                            <div class="card-body card-block" style="overflow:auto; width:1000px; height:auto">
                                <asp:GridView ID="GridViewbankacctlst" Cssclass="table table-striped" runat="server" ShowFooter="True" FooterStyle-BackColor="#3399FF" Font-Bold="True" HeaderStyle-BackColor="#3399FF" PageSize="6" OnPageIndexChanging="newsrchlistpage" AllowPaging="True" >
                ...
                <div id="performance" runat="server">
                    ...
                    <div class="col-md-8 offset-md-3 mr-auto ml-auto">
                        <section class="card">
                            <div class="card-body text-secondary">
                                  <div class="card">
                                                        <div class="card-header">Search For Stastics</div>
                                                        <div class="card-body card-block">
                                                            
                                       <div class="row form-group">
                                                                <div class="col col-md-6">
                                                                 <asp:TextBox ID="TextBox1" runat="server"  class="form-control-sm form-control" TextMode="Date"></asp:TextBox>
                                                          <small class="text-muted text-uppercase font-weight-bold">የመጀመሪያ ቀን</small>                                                                </div>
                                                                <div class="col-12 col-md-6">
                                                                    <asp:TextBox ID="TextBox2" runat="server"  class="form-control-sm form-control" TextMode="Date"></asp:TextBox>
                    <small class="text-muted text-uppercase font-weight-bold">የመጨረሻ ቀን</small> 
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                    <div class="input-group">
                                                                       ...
                                                                       <div class="col col-md-3"> 
                                                                        ...
                                                                        <div class="col col-md-6">
                                                                             <asp:Button ID="Buttstat" runat="server"  class="btn btn-primary btn-sm btn-block" Text="Load Performance" OnClick="Binschart"  />
                     ...
                     <div class="row">
                <div class="col-12">
                    <asp:Chart ID="Chart7" runat="server"   Height="500px" Width="1000px" >
                        <Titles>
                            <asp:Title ShadowOffset="10" Name="Most Sale Products"></asp:Title>
                        ...
                        <Series>
                            <asp:Series Name="Employee with RowMaterial Quantiy"></asp:Series>
                        </Series>
                        <ChartAreas>
                 ...
                 <div class="col-12">
                    <asp:Chart ID="Chart8" runat="server" Height="500px" Width="1000px" >
                        <Titles>
                            <asp:Title ShadowOffset="10" Name="Most Sale Products"></asp:Title>
                        ...
                        <Series>
                            <asp:Series Name="Employee With Product Name"></asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1" BorderWidth="0"></asp:ChartArea>
                        </ChartAreas>
